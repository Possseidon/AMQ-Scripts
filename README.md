...
Scripts:
- [Song List UI](amqSongListUI.user.js?raw=1)
- [Song List](amqSongList.user.js?raw=1)
- [Rig Tracker](amqRigTracker.user.js?raw=1)
- [Rig Tracker Lite](amqRigTrackerLite.user.js?raw=1)
- ~[Team Randomizer](amqTeamRandomizer.user.js?raw=1)~ Deprecated, teams are now an official game mode
- [Dice Roller](amqDiceRoller.user.js?raw=1)
- [Dice Roller UI](amqDiceRollerUI.user.js?raw=1)
- [Speedrun](amqSpeedrun.user.js?raw=1)
- [Chat Timestamps](amqChatTimestamps.user.js?raw=1)
- [Buzzer](amqBuzzer.user.js?raw=1)
- [Song Difficulty Counter](amqSongDifficultyCounter.user.js?raw=1)
- [Rewards Tracker](amqRewardsTracker.user.js?raw=1)
- [Expand Library Search by ANN ID](amqExpandSearchANNID.user.js?raw=1)
- [Short Sample Radio](amqShortSampleRadio.user.js?raw=1)
- [Solo Chat Block](amqSoloChatBlock.user.js?raw=1)
- [AMQ Room Browser Placement](amqRoomBrowserFix.user.js?raw=1)
...
### [Song List UI (amqSongListUI.user.js)](amqSongListUI.user.js?raw=1)
...
### [Song List (amqSongList.user.js)](amqSongList.user.js?raw=1)
...
### [Rig Tracker (amqRigTracker.user.js)](amqRigTracker.user.js?raw=1)
...
### [Rig Tracker Lite (amqRigTrackerLite.user.js)](amqRigTrackerLite.user.js?raw=1)
...
### ~[Team Randomizer (amqTeamRandomizer.user.js)](amqTeamRandomizer.user.js?raw=1)~
...
### [Dice Roller (amqDiceRoller.user.js)](amqDiceRoller.user.js?raw=1)
...
### [Dice Roller UI (amqDiceRollerUI.user.js)](amqDiceRollerUI.user.js?raw=1)
...
### [Speedrun (amqSpeedrun.user.js)](amqSpeedrun.user.js?raw=1)
...
### [Chat Timestamps (amqChatTimestamps.user.js)](amqChatTimestamps.user.js?raw=1)
...
### [Buzzer (amqBuzzer.user.js)](amqBuzzer.user.js?raw=1)
...
### [Song Difficulty Counter (amqSongDifficultyCounter.user.js)](amqSongDifficultyCounter.user.js?raw=1)
...
### [Rewards Tracker (amqRewardsTracker.user.js)](amqRewardsTracker.user.js?raw=1)
...
### [Expand Library Search by ANN ID (amqSearchExpandANNID.user.js)](amqExpandSearchANNID.user.js?raw=1)
...
### [Short Sample Radio (amqShortSampleRadio.user.js)](amqShortSampleRadio.user.js?raw=1)
...
### [Solo Chat Block (amqSoloChatBlock.user.js)](amqSoloChatBlock.user.js?raw=1)
...
### [AMQ Room Browser Placement (amqRoomBrowserFix.user.js)](amqRoomBrowserFix.user.js?raw=1)
